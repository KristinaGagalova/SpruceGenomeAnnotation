...
altest=/path/to/est/alt/evidence #EST/cDNA sequence file in fasta format from an alternate organism
est_gff= #aligned ESTs or mRNA-seq from an external GFF3 file
altest_gff= #aligned ESTs from a closly relate species in GFF3 format

#-----Protein Homology Evidence (for best results provide a file for at least one)
protein=/ppath/to/prot/evidence  #protein sequence file in fasta format (i.e. from mutiple oransisms)
protein_gff=  #aligned protein homology evidence from an external GFF3 file

#-----Repeat Masking (leave values blank to skip repeat masking)
model_org= #all #select a model organism for RepBase masking in RepeatMasker
rmlib=/path/to/repeat/library #provide an organism specific repeat library in fasta format for RepeatMasker
...
gmhmm=/path/to/genemark/hmm #GeneMark HMM file
augustus_species=spruce17 #Augustus gene prediction species model
